...
- 功能性效果：**抽 2 張 ≈ 3 能量**（抽 1 張約 1.5）；能量上限 +1 ≈ 2 能量；挑釁 ≈ 1 能量；
  回復 3 ≈ 1 能量；破壞 1 張道具或場地 ≈ 1–2 能量；HP 減半 ≈ 3 能量。
...
**異常狀態**：中毒、灼燒 2 ≈ 2 能量（每回合都會扣，但生物倒下或進化就沒了）；麻痺 ≈ 2 能量（一回合不能攻擊也不能用技能）；
沉默、繳械 ≈ 1 能量（只擋一半）；虛弱、詛咒 ≈ 1 能量。「對手每隻生物都中」約是單體的 1.5 倍能量。【粗估】
