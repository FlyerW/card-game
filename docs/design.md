...
| 英雄 | 顏色 | HP | 效果 |
|---|---|---|---|
| 無名劍士 | 白 | 52 | 被動「劍士之道」：我方生物 ⚔ +1；我方生物攻擊時，正前方與斜對角都被擋住也打得到英雄 |
...
這一版有攻擊範圍、種族、自己付的能量上限 −X、無名劍士的突破、藍黑控場卡削弱、英雄進化改 UR（無名劍聖 +3/+3）。

| | 現在 | 加攻擊範圍與種族、還沒調之前 | v0.8 |
|---|---|---|---|
| 英雄對其他英雄的平均勝率 | **45.6% – 53.4%** | 41.0% – 57.1% | 46.6% – 54.8% |
| 新制先攻勝率（三種打法） | 54.7% – 56.9% | 54.3% – 56.5% | 51.6% – 53.0% |
...
| 落在 5–10 分鐘 | 72% | 88% | **88%** | 82% | 74% |

| 英雄 | HP | 鏡像先攻勝率 | 平均攻擊次數 | 預估時間（中位數） | 對其他英雄 |
|---|---|---|---|---|---|
| 無名劍士 | 52 | 55.3% | 20.6 | 5.1 分 | 53.4% |
| 翠林聖女（UR） | 58 | 54.7% | 26.8 | 7.3 分 | 52.1% |
| 烈焰領主 | 66 | 54.1% | 14.4 | 8.0 分 | 51.3% |
| 深海先知 | 55 | 50.8% | 26.1 | 10.2 分 | 49.8% |
| 潮影雙生（UR） | 36 | 55.5% | 19.5 | 7.7 分 | 49.5% |
| 林海之王 | 54 | 54.5% | 23.9 | 7.7 分 | 49.1% |
| 冥府祭司 | 44 | 55.1% | 18.5 | 7.5 分 | 49.1% |
| 虹彩賢者（UR） | 40 | 53.4% | 15.7 | 6.3 分 | 45.6% |

1. **八個英雄都在 45%–55%**。虹彩賢者最接近下限，試玩覺得弱可以加 2–3 HP。
2. **對局時間**：55 HP 有 88% 落在 5–10 分鐘。深海先知的對局最長（10.2 分），無名劍士最短（5.1 分，他的生物打得穿位置）。
3. **先攻更有利**：54%–57%，比 v0.8 高。先下場的生物先卡住位置，後攻要打穿比較難。可以考慮給後攻補償（例如爐石的幸運幣）。
4. 牌庫抽完的對局 2.2%，對局變長之後比 v0.8 多，還不算問題。
5. 電腦只看一步，不太會算「擋位置」這種佈局，真人打起來位置的影響可能更大。
