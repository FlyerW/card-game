...
| **灼燒 N** | 擁有者的**回合開始**時受到 N 傷害 | 被擊倒或進化 | 紅 |
...
- **五種**：
  - **中毒**（回合結束時失去 HP，HP 上限也跟著少）、**灼燒**（回合開始時受到傷害）：一直扣到被擊倒或進化
...
- 你中毒的生物失去 HP 與上限，然後換對手的回合。沒花完的能量不保留。
