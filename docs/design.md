...
- 每隻生物每回合可以**攻擊一次**，也可以**發動一個技能一次**，兩個都做也行，順序不限：
  - **攻擊**：不花能量，**只打得到正前方與左右兩個斜對角**（邊邊的格子只有兩格）。那幾格有生物就只能打生物，
    **全都空著才打得到後面的英雄**，跟位置技能同一套規則。打生物時，**對方同時用牠的攻擊力反擊**；打英雄不會被反擊。
  - **技能**：花能量，**不會被反擊**。
...
- 每隻生物每回合**攻擊一次、發動技能一次**，兩個都可以做：
  - **攻擊**：不花能量，只打得到**正前方與兩個斜對角**，那幾格都空著才打得到英雄；打生物時對方**同時反擊**，打英雄不會被反擊
  - **技能**：花能量，**不會被反擊**
