...
| 英雄 | 顏色 | HP | 效果 |
|---|---|---|---|
| 無名劍士 | 白 | 45 | 被動「劍士之道」：我方生物 ⚔ +1，在自己的回合再 +1（攻擊 +2、反擊 +1）；我方生物攻擊時，正前方與斜對角都被擋住也打得到英雄 |
| 深海先知 | 藍 | 41 | 天生技 預見（能量 3）：抽 1 張 |
| 冥府祭司 | 黑 | 37 | 天生技 蝕心（能量 5）：對手隨機棄 1 張 |
| 烈焰領主 | 紅 | 45 | 天生技 燃燼（能量 2）：任意目標 2 傷害 |
| 林海之王 | 綠 | 44 | 天生技 萌發（能量 2）：能量上限 +1，我方英雄與每隻生物回復 2 |
...
| 英雄 | 顏色 | HP | 效果 |
|---|---|---|---|
| 翠林聖女 | 白綠 | 40 | 被動「豐饒」：我方生物 ♥ 上限 +2 |
| 潮影雙生 | 藍黑 | 35 | 天生技輪流：潮之面（能量 4）抽 1 張，用完變成影之面（能量 4）對手隨機棄 1 張，再變回來 |
| 虹彩賢者 | 五色 | 37 | 天生技 稜光（能量 3）：我方每隻生物 +1/+1 |
...
- **林海之王**：萌發 3 費 → 2 費，多了全體回復 2（39% → 52%）。
...
**現在（英雄 HP 35–45、困難電腦）**：英雄兩兩對戰，每組 100 局，共 2800 局
（`BOT=hard` 讓模擬用困難電腦；它一步要想約 30 毫秒，比普通電腦慢 20 多倍，所以局數少）。
一個英雄對其他英雄的平均是 700 局，誤差大約 ±2 個百分點。

| 英雄 | HP | 對其他英雄 | 鏡像先攻勝率 | 平均回合數 | 預估時間（中位數） | 落在 5–10 分鐘 |
|---|---|---|---|---|---|---|
| 林海之王 | 44 | 51.6% | 40% | 17.6 | 7.6 分 | 82% |
| 潮影雙生（UR） | 35 | 51.1% | 56% | 20.0 | 8.1 分 | 76% |
| 冥府祭司 | 37 | 50.9% | 48% | 20.3 | 6.6 分 | 77% |
| 翠林聖女（UR） | 40 | 50.7% | 55% | 16.1 | 6.5 分 | 89% |
| 無名劍士 | 45 | 50.6% | 49% | 13.8 | 5.2 分 | 57% |
| 深海先知 | 41 | 49.1% | 53% | 20.6 | 9.4 分 | 59% |
| 虹彩賢者（UR） | 37 | 48.4% | 40% | 16.9 | 6.5 分 | 81% |
| 烈焰領主 | 45 | 47.6% | 50% | 17.4 | 6.7 分 | 93% |

1. **八個英雄都在 47.6%–51.6%**。
2. **先後攻**：拿掉後攻多的 1 點能量之後，英雄鏡像的先攻勝率平均 48.9%。每組只有 100 局，單一英雄的 40%–56% 大多是誤差。
